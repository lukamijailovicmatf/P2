...
int provera_razlomka(char* razlomak){
  ...
  /* Proveravamo da li su svi karakteri cifre ili '/' i ako nisu, vracamo 0. Pamtimo koliko puta se pojavila razlomacka crta */
  ...
  /* Vracamo nulu ukoliko se razlomacka crta javlja na prvom mestu, na poslednjem mestu, ako se ne pojavljuje uopste ili ukoliko se pojavljuje vise od jednom. */
